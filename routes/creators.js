...
// fetch all creators related to a certain character
router.get("/character/:id/creators", async (req, res) => {
  ...
  try {
    ...
    const response = await axios({
      url: "http://gateway.marvel.com/v1/public/characters/" + id + "/creators",
      method: "get",
      params: {
        apikey,
        ts: timestamp,
